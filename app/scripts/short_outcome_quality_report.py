...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Summarize signal outcome quality for the short bot.")
...
def main(argv: list[str] | None = None) -> None:
    ...
    summary = repository.outcome_quality_summary(hours=24, since=since)
